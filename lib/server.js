...
class Server {
	...
	startServices(ns) {
		...
		if ("home" === this.hostname) {
			...
			if ("attk" === this.focus) {
				...
				if (!ns.isRunning("early.js", this.hostname)) {
					Common.say(ns, "Start service", "early.js");
					ns.exec("early.js", this.hostname);
				}
			}
		}
	...
	stopServices(ns) {
		...
		if (ns.isRunning("early.js", this.hostname)) {
			Common.say(ns, "Stop service", "early.js");
			ns.kill("early.js", this.hostname);
		}
	}
